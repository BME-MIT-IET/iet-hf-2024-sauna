...
public final class MapPanel extends JPanel implements ModelObjectLoadedListener {
     ...
     */
    private final transient Dragger dragger;
    ...
    public void load(Game game) {
        ...
        for (var obj : objectPositions.entrySet()) {
            switch (obj.getClass().getSimpleName()) {
                ...
                default -> throw new IllegalArgumentException(obj.getClass().getSimpleName() + " is not a valid element name");
            }
        }
    ...
    public void paintComponent(Graphics g) {
        ...
        // draw pipes first
        ViewRepository.forEach(PipeView.class::isInstance, v -> v.draw(g));
        ...
        // draw characters
        ViewRepository.forEach(CharacterView.class::isInstance, v -> v.draw(g));
    }
}
